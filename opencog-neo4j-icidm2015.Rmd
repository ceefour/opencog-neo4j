...
maps well to Linked Data technologies, especially reusing Resource Description Framework (RDF), Schema.org, and YAGO ontologies. This is an elaborate design to ease collaboration with other researchers and the technology industry players, particularly from the Linked Data community, YAGO researchers, and Artificial Intelligence community.
