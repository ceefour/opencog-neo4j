...
We create [a graph backing store](http://wiki.opencog.org/w/Neo4j_Backing_Store)[1] for [OpenCog](http://www.opencog.org/)[2, 3, 26, 27, 28] using [Neo4j graph database](http://neo4.org/)[4]. The GraphBackingStore API extends the current BackingStore C++ API. It can take special queries that map naturally into Cypher queries and simple manipulations of Neo4j graph traversals.
...
1. [`SimpleTruthValue`](http://wiki.opencog.org/wikihome/index.php/SimpleTruthValue). Holds two floating-point values, commonly called "strength" and "confidence".
2. [`CountTruthValue`](http://wiki.opencog.org/wikihome/index.php/CountTruthValue). Holds three floating point values. One is typically a raw count (integer) of having seen some event. Another is typically the logarithm of the normalized frequency (i.e. observed probability) of the event.
3. [`IndefiniteTruthValue`](http://wiki.opencog.org/wikihome/index.php/IndefiniteTruthValue). Holds four floating point numbers.
4. [`FuzzyTruthValue`](http://wiki.opencog.org/wikihome/index.php/FuzzyTruthValue). Fuzzy truth value.
5. [`GenericTruthValue`](http://wiki.opencog.org/wikihome/index.php/GenericTruthValue). Generic truth value.
6. [`NullTruthValue`](http://wiki.opencog.org/wikihome/index.php/NullTruthValue). A special type of truth value.
7. [`ProbabilisticTruthValue`](http://wiki.opencog.org/wikihome/index.php/ProbabilisticTruthValue). A truth value that stores a mean, a confidence and the number of observations.
...
### Linked Data, RDF, SKOS, Schema.org, and YAGO Integration

The structure and naming of the vertices, edges, and properties of the OpenCog Neo4j graph database are designed to facilitate integration with [Linked Data](http://linkeddata.org/)[17] technologies, with special considerations for [Resource Description Framework (RDF)](http://www.w3.org/RDF/)[18], [Simple Knowledge Organization System (SKOS)](http://www.w3.org/2004/02/skos/)[31], [Schema.org](http://schema.org/)[19], and [YAGO](http://www.mpi-inf.mpg.de/departments/databases-and-information-systems/research/yago-naga/yago/)[20, 30, 32] ontologies.
...
| `prefLabel` | Preferred label | http://www.w3.org/2008/05/skos#prefLabel |  [Simple Knowledge Organization System (SKOS)](http://www.w3.org/2004/02/skos/) |
...
20. Suchanek, Fabian M., Gjergji Kasneci, and Gerhard Weikum. ["Yago: A Core of Semantic Knowledge."](http://dl.acm.org/citation.cfm?id=1242667) Proceedings of the 16th International Conference on World Wide Web. ACM, 2007.
...
30. Mahdisoltani, Farzaneh, Joanna Biega, and Fabian Suchanek. "YAGO3: A knowledge base from multilingual Wikipedias." 7th Biennial Conference on Innovative Data Systems Research. CIDR 2015, 2014. http://pubman.mpdl.mpg.de/pubman/item/escidoc:2077946/component/escidoc:2077968/CIDR15_Paper1.pdf.
31. W3C. SKOS Simple Knowledge Organization System. http://www.w3.org/2004/02/skos/.
32. Max Planck Institute for Informatics. YAGO: A High-Quality Knowledge Base. http://www.mpi-inf.mpg.de/departments/databases-and-information-systems/research/yago-naga/yago/.
